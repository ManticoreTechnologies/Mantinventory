...
android {
    namespace = "com.manticore.mantinventory"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.manticore.mantinventory"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
    ...
    signingConfigs {
        create("release") {
            ...
            storePassword = "mantinventory2024"
            keyAlias = "mantinventory"
            keyPassword = "mantinventory2024"
        }
    }
